		...
		<View style={styles.monthSelectorWrap}>
			<View style={styles.yearNavRow}>
				<Pressable
					hitSlop={10}
					onPress={() => {
						if (!isFirstYear) onSetYear(years[yearIdx - 1]!);
					}}
					style={[
						styles.yearNavArrow,
						isFirstYear && styles.yearNavArrowDisabled,
					]}
				>
					<Ionicons
						color={isFirstYear ? theme.border : theme.primary}
				...
				<Pressable
					hitSlop={10}
					onPress={() => {
						if (!isLastYear) onSetYear(years[yearIdx + 1]!);
					}}
					style={[
						styles.yearNavArrow,
						isLastYear && styles.yearNavArrowDisabled,
					]}
				>
					<Ionicons
						color={isLastYear ? theme.border : theme.primary}
