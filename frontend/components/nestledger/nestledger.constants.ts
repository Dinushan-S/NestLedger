import { avatarChoices, expenseCategories, expenseFilters } from '../../constants/nestledger';
...
export const SPACE_TYPES: { type: SpaceType; emoji: string; label: string; desc: string }[] = [
